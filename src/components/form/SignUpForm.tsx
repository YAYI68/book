  ...
  return (
    <div className='w-[80%] lg:w-[60%] lg:flex h-[90%] lg:h-[80%] flex flex-col items-center p-4 '>
      ...
      <form action="" className='mt-[2rem] w-full flex flex-col gap-4'>
        ...
        <input type="password" placeholder='Confirm Password' className='px-4  py-2 w-full outline-none border dark:bg-gray-800 dark:text-white rounded ' />
        ...
        <div className='w-fit flex baseline gap-2'>
          <input type="checkbox" name="" id="show_password" />
          <label htmlFor="show_password" className='dark:text-gray-300'>by signing up you have agree to our terms and conditions</label>
        </div>
        <button className='w-full text-center bg-red-500 text-white p-2 rounded-md font-medium'>SignUp</button>
      </form>
