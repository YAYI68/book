...
const LibraryBook = (props: Props) => {
  return (
    <div className="h-[23rem] w-full md:w-[43%] lg:w-[23%]">
      <div className="w-full h-[85%] bg-purple-500 relative overflow-hidden group">
        <div className="absolute w-full transition-[transform] bottom-0 left-0 translate-y-[105%] flex p-2 justify-center items-center  group-hover:translate-y-0 bg-white">
          <Link
            href={"/"}
