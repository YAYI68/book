...
const TrendingBooks = (props: Props) => {
  return (
    ...
    <div className='w-[90%] flex items-center md:items-center lg:items-start flex-col gap-4 '>
     <h3 className='font-semibold text-[1.5rem] dark:text-white '>TRENDING BOOKS</h3>
        ...
        <div className='w-full dark:border dark:bg-black bg-white shadow-2xl flex flex-col md:gap-12 md:flex-row  md:h-[18rem] md:shadow-xl md:px-[2rem] md:pb-[2rem]'>
           ...
           <div className=' md:w-[65%] p-4 gap-2 md:gap-0 flex flex-col justify-between pt-[2rem] h-full '>
             <div className='w-full'>
               <h4 className='dark:text-white font-medium'>HISTORICAL CONCEPTS</h4>
               <small className='text-xs text-gray-400'>By Lawal Odumeji</small>
             </div>
             <p className='dark:text-white'>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maxime at iusto illo consequatur eum dolorem labore quibusdam cupiditate, enim eius itaque, consectetur quod corrupti. Aliquam cupiditate facere nostrum molestias debitis?</p>
             <button  className='bg-red-500 w-fit text-white py-2 px-4'>Read now</button>
           </div>
        </div>
     </div>
