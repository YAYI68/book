            ...
            <div className='w-[90%] flex flex-col md:justify-between gap-4 items-center md:flex-row md:h-[60vh] '>
               ...
               <div className='md:w-[70%] p-2 md:h-full flex flex-col  w-full h-[20rem] md:gap-4'>
                 <div className='w-full pb-4 border-b-2'>
                   <h3 className='text-[1.5rem] font-semibold dark:text-white'>The Psychology of Man</h3>
                ...
                <div className='py-4'>
                   ...
                   <p className='text-gray-600 dark:text-gray-300 text-[1.2rem]'>Get all the academic knowledge you ever need by subscribing and reading our books online at a lower cost. </p>
                </div>
                ...
                <div className='flex flex-col md:flex-row md:gap-4 md:w-[70%]'>
                    <button className='text-center md:w-[45%] py-2 px-4 border dark:text-white dark:border-gray-400 font-semibold border-black rounded hover:bg-red-500 hover:border-red-500 hover:text-white'>Add to Library</button>
                    <button className='text-center md:w-[45%] py-2 px-4 border font-semibold hover:bg-red-700 border-red-500 bg-red-500 text-white rounded'>Read Now</button>
                </div>
               </div>
            </div>
        </section>
